...
public class PokemonFuego  extends Pokemon {
	...
	public PokemonFuego(String nombre, String tipo, float peso, float altura, Integer hp, Integer pc) {
	...
	public void atacar(Pokemon pkm) {
		...
		System.out.println(this.nombre + " a lanzado BOLA DE FUEGO!!");
		Random r = new Random();
		...
		case 0:
			...
			break;
		case 1:
			if(pkm.getClass()==PokemonElectrico.class)
			{
				ataque = opAtaque*2;
